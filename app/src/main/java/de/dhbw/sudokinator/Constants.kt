...
const val SUDOKU_ROWS = 9
const val SUDOKU_COLUMNS = 9
...
const val UNIQUE_PROCESS_SUDOKU_WORKER_ID = "uniqueProcessorWorkerId"
const val BITMAP_FILE_NAME = "extracted-sudoku.png"